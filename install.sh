#!/bin/bash
# Installs GrabTaxi's IntelliJ configs into your user configs.

echo "Installing GrabTaxi code style configs..."
...
echo "Done."
echo ""
echo "Restart IntelliJ and/or AndroidStudio, go to preferences, and apply 'GrabTaxiAndroid'."
